...
# cap = cv.VideoCapture(f"ArucoMarkers\Videos\WIN_20221025_21_25_39_Pro.mp4")
...
while True:
    ret, frame = cap.read()  # ret (boolean type) - checks of a frame was returned
    if not ret:
        break
    ...
    try:
        ...
        for i in range(0, len(corner)):
            ...
            # cv.putText(frame, str(index), (50, 50))
